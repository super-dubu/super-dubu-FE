      ...
      <Container>
        ...
        <Table>
          <Row>
            <Label>보증금</Label>
            <InputRow>
              금 <Input $large /> 원정 <Input $large placeholder="₩" />
            </InputRow>
          </Row>
          <Row>
            <Label>계약금</Label>
            <InputRow>
              금 <Input $large /> 원정 <Input $large placeholder="₩" />은
          ...
          <Row>
            ...
            <InputRow>
              {" "}
              금<Input $large />는 원정은 매월 <Input />
              일에 지불한다. (입금 계좌 : <Input $large /> )
            </InputRow>
          </Row>
          <Row>
            <Label>관리비</Label>
        ...
        <Text>
          ...
          사용‧수익할 수 있는 상태로 <Input />년 <Input />월 <Input />
          일까지 임차인에게 인도하고, <br />
          임대차기간은 인도일로부터 <Input />년 <Input />월 <Input />
          일까지로 한다.{" "}
        </Text>
